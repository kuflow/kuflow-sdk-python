...
class KuFlowClient:  # pylint: disable=client-accepts-api-version-keyword
    ...
    def __init__(
        ...
        self.principals = PrincipalOperations(self._kuflow_client)
        ...
        # self.api_rest_external_v20221008_echo = ApiRestExternalV20221008EchoOperations(
        #     self._client, self._config, self._serialize, self._deserialize
        # )
        # self.api_rest_external_v20221008_authentications = ApiRestExternalV20221008AuthenticationsOperations(
        #     self._client, self._config, self._serialize, self._deserialize
        # )

        # self.api_rest_external_v20221008_processes = ApiRestExternalV20221008ProcessesOperations(
        #     self._client, self._config, self._serialize, self._deserialize
        # )
        # self.api_rest_external_v20221008_tasks = ApiRestExternalV20221008TasksOperations(
        #     self._client, self._config, self._serialize, self._deserialize
        # )
